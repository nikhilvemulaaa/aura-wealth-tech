...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "YONO AI — Wealth Navigator" },
      { name: "twitter:title", content: "YONO AI — Wealth Navigator" },
      { property: "og:description", content: "Hyper-personalized AI-powered wealth management for modern India." },
      { name: "twitter:description", content: "Hyper-personalized AI-powered wealth management for modern India." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/005994d4-b32e-417c-ad53-f12ac569816f" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/005994d4-b32e-417c-ad53-f12ac569816f" },
